...
cd ..
cat genetik.htm 1/all.htm 2/all.htm 3/all.htm 4/all.htm 5/all.htm 6/all.htm 7/all.htm 8/all.htm 9/all.htm 10/all.htm 11/all.htm 12/all.htm applets/all.htm >all.htm 

rm */all.htm
find . -name "all.htm*" -print -exec perl -pi -e 's/^\<html\>\<br\>/\<bodx\>/i' {} \;
...
find . -name "all.htm*" -print -exec perl -pi -e 's/.*\>Volver a.*//gi' {} \;
find . -name "all.htm*" -print -exec perl -pi -e 's/.*\>P.gina .*//gi' {} \;
...
find . -name "all.htm*" -print -exec perl -pi -e 's/^\<bodx\>/<html><body>/' {} \;
find . -name "all.htm*" -print -exec perl -pi -e 's/.*Cap.tulo sig.*//i' {} \;
find . -name "all.htm*" -print -exec perl -pi -e 's/.*cap.tulo an.*//i' {} \;
